...
const SIGNAL_DICTIONARY: SignalDictionaryEntry[] = [
  { signal: 'work_signal', score: 70, terms: ['work', 'working', 'remote work', 'trabajar', 'trabajo remoto', 'cowork', 'sit-down coffee'] },
  { signal: 'laptop_signal', score: 76, terms: ['laptop', 'notebook', 'computer', 'computadora', 'portatil', 'portátil'] },
  { signal: 'wifi_signal', score: 72, terms: ['wifi', 'wi-fi', 'internet'] },
  { signal: 'outlet_signal', score: 70, terms: ['outlet', 'plug', 'power socket', 'enchufe', 'enchufes', 'tomacorriente'] },
  { signal: 'study_signal', score: 70, terms: ['study', 'studying', 'estudiar', 'estudio'] },
  { signal: 'quiet_signal', score: 68, terms: ['quiet', 'calm', 'tranquilo', 'tranquila', 'silencioso', 'relajado'] },
  { signal: 'reading_signal', score: 64, terms: ['read', 'reading', 'leer', 'lectura', 'book', 'libro'] },
  { signal: 'long_stay_signal', score: 66, terms: ['long stay', 'stay awhile', 'sit for hours', 'quedarse', 'pasar la tarde', 'comfortable seating'] },
  { signal: 'quick_stop_signal', score: 62, terms: ['quick', 'to go', 'takeaway', 'take away', 'para llevar', 'al paso', 'counter'] },
  { signal: 'seating_signal', score: 66, terms: ['seating', 'tables', 'chairs', 'sillas', 'mesas', 'asientos', 'sit-down', 'sentarse'] },
  { signal: 'interior_signal', score: 64, terms: ['interior', 'inside', 'indoors', 'adentro', 'interiores', 'salon', 'salón'] },
  { signal: 'crowded_signal', score: 72, terms: ['crowded', 'packed', 'busy', 'lleno', 'llena', 'abarrotado', 'mucha gente'] },
  ...
  { signal: 'romantic_signal', score: 68, terms: ['romantic', 'romantico', 'romántico', 'intimate', 'íntimo', 'intimo', 'candle', 'low-lit'] },
  ...
  { signal: 'wine_signal', score: 74, terms: ['wine', 'vino', 'vinos', 'sommelier', 'malbec', 'natural wine'] },
  { signal: 'cocktail_signal', score: 74, terms: ['cocktail', 'cocktails', 'coctel', 'cóctel', 'bar', 'vermouth'] },
  { signal: 'dinner_signal', score: 68, terms: ['dinner', 'cena', 'restaurant', 'restaurante', 'menu', 'tasting menu', 'parrilla'] },
...
const CONSTRAINT_DICTIONARY: ConstraintDictionaryEntry[] = [
  { constraint: 'crowded', terms: ['crowded', 'packed', 'lleno', 'llena', 'abarrotado', 'mucha gente'] },
  ...
  { constraint: 'no_seating', terms: ['no seating', 'sin asientos', 'no seats', 'no hay mesas'] },
  { constraint: 'takeaway_first', terms: ['takeaway', 'to go', 'para llevar', 'al paso', 'coffee to go'] },
