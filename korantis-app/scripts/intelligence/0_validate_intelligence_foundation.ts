...
const mocks: MockVenue[] = [
  ...
  },
  {
    ...
    experienceSignals: { ...zeroExperience(), formal_signal: 86, dinner_score: 0, night_signal: 78, intimate_signal: 72, conversation_signal: 74, romantic_signal: 68, social_signal: 62 },
  ...
  },
  {
    ...
    experienceSignals: { ...zeroExperience(), lively_signal: 82, social_signal: 76, dinner_score: 0, conversation_signal: 45, formal_signal: 60, night_signal: 70, quick_stop_signal: 58 },
